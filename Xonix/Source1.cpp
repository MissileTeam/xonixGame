...
//
//	Font farial;
//	farial.loadFromFile("Data/arial.ttf");
//
//	ostringstream hhcore;
//	hhcore << "High Score : " << highscore;
//	Text labelhighscore;
//	labelhighscore.setCharacterSize(20);
//	labelhighscore.setPosition({ 30, 40 });
//	labelhighscore.setFont(farial);
//	labelhighscore.setString(hhcore.str());
//
//
//	// event
//	Event event;
...
//	*/
//
//	//sound after a completetion 
//	SoundBuffer sound;
//	Sound completesound;
//	if (sound.loadFromFile("Data/completion_sound"))
//		cout << "good" << endl;
//	completesound.setBuffer(sound);
//
//	while (play)
//	{
//		Sprite Sgrid;
...
//		labelscore.setString(sscore.str());
//
//		//saving score on file
//		fstream readfile;
//		readfile.open("Data/ScoreSaving.txt");
//		if (readfile.is_open())
//		{
//			while (!readfile.eof())
//			{
...
//		readfile.close();
//
//		ofstream writefile("Data/ScoreSaving.txt");
...
//
//			// make the enemies more smarter 
//			if (enemies_struct[i].expostion > xpos)
//				enemies_struct[i].expostion--;
//			if (enemies_struct[i].eypostion > ypos)
//				enemies_struct[i].eypostion--;
//		}
//
//
